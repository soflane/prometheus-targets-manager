 ...
 */
final class Version20211101131828 extends AbstractMigration {

  public function getDescription(): string {
    return 'Create User, Target, CustomField, CustomFieldValue entities';
  }
  ...
  public function up(Schema $schema): void {
    ...
    $this->addSql('CREATE TABLE custom_field_value (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', custom_field_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', target_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', INDEX IDX_EC7B05A1E5E0D4 (custom_field_id), INDEX IDX_EC7B05158E0B66 (target_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
